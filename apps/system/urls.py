...
from apps.system.views import DictDataModelViewSet, DictDetailsModelViewSet, \
    ConfigSettingsModelViewSet, SaveFileModelViewSet, MessagePushModelViewSet, LoginInfoModelViewSet, \
    OperationLogModelViewSet, CeleryLogModelViewSet, SystemInfoApiView, GetLocalIp
...
urlpatterns = [
    ...
    re_path('local_ip/', GetLocalIp.as_view())
