# Generated by Django 2.2.16 on 2022-04-19 07:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='', max_length=255, unique=True, verbose_name='项目名称(unique)')),
                ('apis', models.ManyToManyField(to='api.Api', verbose_name='接口列表')),
