<template>
    <div style="display: flex; justify-content: space-around; flex-wrap: wrap">
        ...
        <div style="width: 50%;" class="report">
            <el-card>
                <div slot="header">
                    <span>报告比例</span>
                </div>
        ...
        <div style="width: 40%;" class="report">
            <el-card>
                <div slot="header">
                    <span>报告日-周-月趋势</span>
                </div>
    ...
    data() {
        return {
            ...
            optionsWeekBar: {
                ...
                xaxis: {
                    categories: ['前5周', '前4周', '前3周', '前2周', '前1周', '当前周'],
                },
                fill: {
                    opacity: 1
                },
            ...
            optionsMonthBar: {
                ...
                xaxis: {
                    categories: ['前5月', '前4月', '前3月', '前2月', '前1月', '当前月'],
                },
                fill: {
                    opacity: 1
                },
    ...
    methods: {
        getData() {
            this.$api.getDashBoard().then(resp => {
                ...
                this.optionsLine = {...this.optionsLine, ...{labels: resp.recent_days}}
                // 每周
                ...
                this.optionsWeekBar = {...this.optionsWeekBar, ...{xaxis: {categories: resp.recent_weeks}}}
                // 每月
                ...
                this.optionsMonthBar = {...this.optionsMonthBar, ...{xaxis: {categories: resp.recent_months}}}
            })
        },
    },
    mounted() {
