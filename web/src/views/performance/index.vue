  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
      ...
      <el-form-item label="类型" prop="point_type">
        <el-select v-model="queryParams.point_type" placeholder="FPS/CPU/MER.." clearable size="small">
          <el-option
      ...
      <el-form-item label="页面" prop="status">
        <el-select v-model="queryParams.status" placeholder="页面" clearable size="small">
          <el-option
      ...
      <el-form-item label="版本" prop="point_type">
        <el-select v-model="queryParams.suite_id" placeholder="版本" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="部门" align="center" prop="zh_name" sortable :show-overflow-tooltip="true"/>
      <el-table-column label="类型" align="center" prop="point_type" sortable width="120" :formatter="typeFormat"/>
      <el-table-column label="页面" align="center" prop="curr_page" sortable :show-overflow-tooltip="true"/>
      <el-table-column label="avg" align="center" prop="from_action" sortable :show-overflow-tooltip="true"/>
